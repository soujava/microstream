...
{
	/**
	 * returns the current type informations available
	 * 
	 * @return the actual type informations
	 */
	 ...
	 * 
	 * @return true if there are updated type infos
	 */
	...
	/**
	 * 
	 * This implementation includes only type informations for types added to the
	...
	/**
	 * 
	 * This implementation includes type informations for types added to the
	...
	/**
	 * 
	 * This implementation includes type informations for all types currently known
